...
import { Landmark, Users, Search, Award, Info, Sparkles, ChevronDown, CheckCircle2 } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-xs">
      ...
      <div className="bg-slate-900 text-slate-300 text-xs px-4 py-1.5 flex flex-wrap justify-between items-center border-b border-slate-800">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-slate-200">SchemeSaathi Civic-Tech Platform</span>
          <span className="text-slate-500">|</span>
          <span className="text-slate-400 hidden sm:inline">Family-Based Government Eligibility Engine</span>
        </div>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-bold text-xl tracking-tight text-slate-900 font-display">SchemeSaathi</span>
              ...
              <p className="text-[11px] text-slate-500 -mt-0.5">Government Scheme Discovery</p>
            </div>
          </button>
          ...
          <div className="relative">
            <button
              ...
              className="bg-amber-50 text-amber-800 hover:bg-amber-100 border border-amber-300/80 px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-1.5 transition-all shadow-xs"
                ...
                <div className="py-1 space-y-1">
                  {DEMO_PROFILES.map((preset) => (
                    <button
                      ...
                      className="w-full text-left p-2.5 rounded-lg hover:bg-slate-50 transition-colors flex flex-col gap-0.5 group"
                    >
